...
export default function FrrostMediaPage() {
  const schema = {
    ...
    "@type": "Organization",
    name: "FRROST Media",
    url: EXTERNAL_LINKS.frrostMedia,
